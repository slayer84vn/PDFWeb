<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Contact.aspx.cs" Inherits="PDFWeb.Contact" Title="DANH BẠ ĐƠN VỊ" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:EntityDataSource ID="EntityDataSourceContact" runat="server" ConnectionString="name=PDFEntities" DefaultContainerName="PDFEntities" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EnableDelete="true" EntitySetName="tblDM_DanhBa">
