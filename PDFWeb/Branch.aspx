<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Branch.aspx.cs" Inherits="PDFWeb.Branch" Title="ĐƠN VỊ" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        KeyFieldName="BranchID" EnablePagingGestures="False"
        CssClass="grid-view" Width="100%" AutoGenerateColumns="False" DataSourceID="EntityDataSourceBranch" OnCellEditorInitialize="GridView_CellEditorInitialize">
        ...
        <SettingsText CommandEdit="Chỉnh sửa" CommandCancel="Hủy" CommandUpdate="Cập nhật" PopupEditFormCaption="Đơn vị"  />
        <SettingsPopup>
            <EditForm>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="BranchID" VisibleIndex="1" Caption="Mã đơn vị">
                <PropertiesTextEdit>
                    <ValidationSettings RequiredField-IsRequired="true"></ValidationSettings>
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="BranchName" VisibleIndex="2" Caption="Tên đơn vị">
                <PropertiesTextEdit>
                    <ValidationSettings RequiredField-IsRequired="true"></ValidationSettings>
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
    ...
    <asp:EntityDataSource ID="EntityDataSourceBranch" runat="server" ConnectionString="name=PDFEntities" DefaultContainerName="PDFEntities" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="tblDM_Branch">
