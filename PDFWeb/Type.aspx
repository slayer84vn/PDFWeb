<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Type.aspx.cs" Inherits="PDFWeb.Type" Title="LOẠI DỮ LIỆU" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        KeyFieldName="TypeID" EnablePagingGestures="False"
        CssClass="grid-view" Width="100%" AutoGenerateColumns="False" DataSourceID="EntityDataSourceType" OnCellEditorInitialize="GridView_CellEditorInitialize">
        ...
        <SettingsText CommandEdit="Chỉnh sửa" CommandCancel="Hủy" CommandUpdate="Cập nhật" PopupEditFormCaption="Loại dữ liệu"  />
        <SettingsPopup>
            <EditForm>
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="TypeID" VisibleIndex="1" Caption="Mã loại dữ liệu">
                <PropertiesTextEdit>
                    <ValidationSettings RequiredField-IsRequired="true"></ValidationSettings>
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="TypeName" VisibleIndex="2" Caption="Tên loại dữ liệu">
                <PropertiesTextEdit>
                    <ValidationSettings RequiredField-IsRequired="true"></ValidationSettings>
                </PropertiesTextEdit>
            </dx:GridViewDataTextColumn>
    ...
    <asp:EntityDataSource ID="EntityDataSourceType" runat="server" ConnectionString="name=PDFEntities" DefaultContainerName="PDFEntities" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="tblDM_Type">
