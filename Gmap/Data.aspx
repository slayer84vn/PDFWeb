<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Data.aspx.cs" Inherits="Gmap.Data" Title="QUẢN LÝ NGƯỜI DÙNG" %>
    ...
    <dx:ASPxMenu runat="server" ID="PageToolbar" ClientInstanceName="pageToolbar"
        ...
        <Items>
            <dx:MenuItem Enabled="false">
                <Template>
                    <h1>DỮ LIỆU BẢN ĐỒ CHXD</h1>
                </Template>
            </dx:MenuItem>
            <dx:MenuItem Name="Export" Text="Xuất Excel" Alignment="Right" AdaptivePriority="2">
                <Image Url="Content/Images/export.svg" />
            </dx:MenuItem>
            <dx:MenuItem Name="ExportPDF" Text="Xuất PDF" Alignment="Right" AdaptivePriority="2">
                <Image Url="Content/Images/export.svg" />
            </dx:MenuItem>
        </Items>
    </dx:ASPxMenu>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    <dx:ASPxGridView runat="server" ID="GridView" ClientInstanceName="gridView"
        ...
        CssClass="grid-view" Width="100%" AutoGenerateColumns="False" DataSourceID="EntityDataSourceData" >
    ...
    <asp:EntityDataSource  ID="EntityDataSourceData" runat="server" ConnectionString="name=CHXD_MapEntities" DefaultContainerName="CHXD_MapEntities" EnableDelete="False" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="tblDatas" EntityTypeFilter="tblData">
